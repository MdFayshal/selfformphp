        ...
        <div class="jumbotron">
            ...
            <table class=" float-end text-info">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a class="btn btn-primary float-end" data-bs-toggle="collapse" href="#multiCollapse1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Add</a>
                        </td>
